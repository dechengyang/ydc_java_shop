...
public abstract class ApiCallBack<M> extends Subscriber<M> {
    ...
    public void onNext(M modelBean) {
        if (modelBean != null) {
            ...
            if (feed.getCode().equals("4002")) {
                Intent msgIntent = new Intent("business.com.businessapp.receiverCode_toUpdateMainActivity.intent.MESSAGE_RECEIVED");
                //msgIntent.putExtra("code", "4001");
                msgIntent.putExtra("code", feed.getCode());
                //DataManagementCenter.mAppContext.sendBroadcast(msgIntent);

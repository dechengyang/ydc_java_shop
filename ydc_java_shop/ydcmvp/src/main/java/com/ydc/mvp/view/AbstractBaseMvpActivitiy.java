 ...
 */
public abstract class AbstractBaseMvpActivitiy<V extends IBaseMvpView, P extends BaseMvpPresenter<V>> extends Activity implements PresenterProxyInterface<V,P> {

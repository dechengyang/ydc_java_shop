...
import com.ydcjavashop.shop.view.swipetoloadlayout.base.MaterialProgressDrawable;
...
public class GoogleCircleProgressView extends ImageView {
    ...
    public void setColorSchemeResources(int... colorResIds) {
        ...
        for (int i = 0; i < colorResIds.length; i++) {
            colorRes[i] = ContextCompat.getColor(mContext,colorResIds[i]);
        }
    ...
    public void setBackgroundColor(@ColorRes int colorRes) {
        if (getBackground() instanceof ShapeDrawable) {
            ((ShapeDrawable) getBackground()).getPaint().setColor(ContextCompat.getColor(mContext,colorRes));
        }
    }

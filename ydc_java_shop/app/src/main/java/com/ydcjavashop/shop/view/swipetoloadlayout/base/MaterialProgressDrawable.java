...
public class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    public void stop() {
        ...
        mRing.setColorIndex(0);
        mRing.resetEndOriginals();
        //布局还原后重置状态  1000:还原的默认时间
        mAnimExcutor.postDelayed(new Runnable() {
            @Override
            public void run() {
                mRing.resetStartOriginals();
            }
    ...
    private static class Ring {
         ...
         */
        public void resetStartOriginals() {
